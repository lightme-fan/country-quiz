    ...
    return (
        <>
            ...
            <div className='buttons'>
                <button value={answers[0]} onClick={onClick}>{answers[0]}</button><br />
                <button value={answers[1]} onClick={onClick}>{answers[1]}</button><br/>
                <button value={answers[2]} onClick={onClick}>{answers[2]}</button><br/>
                <button value={answers[3]} onClick={onClick}>{answers[3]}</button>
            </div>
        </>
    )
}
